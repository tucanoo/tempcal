	...
	-----------------------------------------------------------------------------*/
		...
		function calcSize() { // assumes elementVisible
			if (options.contentHeight) {
				...
				if( jQuery.isFunction(options.height)) {
...
// TODO: test liquid width, especially in IE6
	...
	-----------------------------------------------------------------------*/
		...
		function buildSkeleton() {
			...
			/* customization from xtradesoft. (add class to identify) **/
			slotScroller =
				$("<div class='scroller' style='position:absolute;width:100%;overflow-x:hidden;overflow-y:auto'/>")
					.appendTo(slotLayer);
	...
	----------------------------------------------------------------------------*/
			...
			for (i=0; i<segCnt; i++) {
				...
				if (levelI) {
					...
					if (forward) {
						...
						outerWidth = ((availWidth / (forward + 1))); // - (12/2)) * 2; // 12 is the predicted width of resizer =  @see https://code.google.com/p/fullcalendar/issues/detail?id=218
					}else{
				...
				seg.top = top;
				seg.left = left;
				seg.outerWidth = outerWidth -1; // @see https://code.google.com/p/fullcalendar/issues/detail?id=218
		...
		function slotSegHtml(event, seg) {
			...
			html +=
				...
				"'" +
				">" +
				/* start customization xtradesoft
      ...
      */
				...
				"</span>"
			/* customization xtradesoft
        +
			"</span>" */
			/**** end customization xtradesoft *******/
			;
	...
	function DayEventRenderer() {
		...
		function buildHTMLForSegment(segment) {
			...
			html +=
				...
				"'" +
				">"
			; // + "<div class='fc-event-inner'>"; // start customization xtradesoft
			...
			html +=
				...
				htmlEscape(event.title || '') +
				"</span>"
			; // + "</div>"; // End customization xtradesoft
